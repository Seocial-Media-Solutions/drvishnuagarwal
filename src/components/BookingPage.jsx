  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 bg-white rounded-lg shadow-lg text-blue-800">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2">
                  {availableSlots.map((slot) => (
                    <button
                      ...
                      className={`py-3 px-2 text-sm border rounded-md transition-all ${selectedSlot === slot
          ...
          {selectedSlot && selectedSlot !== 'Closed' && (
            <div className="space-y-4">
              ...
              <button
                ...
                className={`w-full py-3 px-4 rounded-md cursor-pointer transition-all ${isLoading || !firestoreReady
      ...
      <div className="p-4 mt-6 bg-gradient-to-r from-blue-100 to-teal-100 bg-opacity-20 rounded-md text-blue-800">
        <h3 className="font-bold text-lg mb-2">Agrawal Urology Clinic Ajmer</h3>
