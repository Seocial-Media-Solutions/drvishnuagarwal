...
import { Hospital, Stethoscope, Syringe } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-16">
          <div className="md:flex">
            <div className="md:w-2/3 p-8 md:p-12">
              ...
              >
                Urology Health Blog by Dr. Vishnu Agrawal
              </motion.h1>
              ...
              >
                {`Expert articles on urological conditions, treatments, and men's health from one of Ajmer's leading urologists.`}
              </motion.p>
            ...
            {currentBlogs.map((blog, blogIndex) => (
              ...
              >
                <div className="relative aspect-video w-full overflow-hidden">
                  <Image
                    src={blog.image || "/images/urology-blog-placeholder.jpg"}
                  ...
                  />
                  {blog.tags?.[0] && (
                    <span className="absolute bottom-4 right-4 bg-gradient-to-br from-blue-900 via-blue-800 to-teal-600 text-white text-xs px-3 py-1 rounded-full">
                      {blog.tags[0]}
                    </span>
                  )}
                </div>
          ...
          <div className="md:flex">
            ...
            >
              <h3 className="text-2xl font-bold mb-4">
                About Dr. Vishnu Agrawal
              </h3>
              <p className="mb-6">
                One of the best urologists in Ajmer with expertise in
                laparoscopic surgery and comprehensive urological care.
              </p>
              <div className="space-y-3">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">MBBS, MS (Urology)</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <svg
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Practicing since 2008</p>
                  </div>
                </div>
              </div>
            </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Minimally invasive surgical techniques for urological
                        conditions
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Expert in kidney stone treatment and renal surgeries
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Andrology</h4>
                      <p className="text-gray-600">
                        Specialized care for male reproductive and urinary
                        health
                      </p>
                    </div>
                  </div>
